...
def score(bot, update):
    try:
        ...
        update.message.reply_text("Вы убили " + a['kills'] + " врагов.")
        update.message.reply_text("Вы десантировались " + a['desanting times'] + " раз.")
        update.message.reply_text("Ваш ранг " + a['rang'])
    except:
        update.message.reply_text("Ошибка в штабе командования, шшш...")
        time.sleep(300)
...
def rules(bot, update):
    update.message.reply_text(
        "Ваша задача десантироваться на территория и передвигаясь по карте уничтожить врагов коммунизма, играя за гиганского робота. Вперед к победе, Comrade")
